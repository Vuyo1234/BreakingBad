...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.charName.text = characterDeats[indexPath.row].name.uppercased()
        cell.charNickname.text = characterDeats[indexPath.row].nickname.uppercased()
    ...
    func downloadCharacterJSON(completed: @escaping () -> ())
       {
           ...
           let url = URL(string: "https://www.breakingbadapi.com/api/characters?limit=2")!
